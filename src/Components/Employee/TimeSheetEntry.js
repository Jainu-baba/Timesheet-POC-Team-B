                    ...
                    <thead className='table-secondary'>
                        <tr className='bg-primary'>
                            ...
                            {selectedDates && selectedDates.length > 0 && selectedDates.map((date, index) => {
                                return <th className='col-md-1'>{date ?? ''}</th>
                            })}
...
=======
                                    <td ><input  type="text" class="form-control text-center"  disabled={role === 'manager' ? true : false} value={row.day1} onChange={(event) => changeTimeSheetData('day1', index, Math.min(event.target.value, 16))} /></td>
                                    <td ><input type="text" class="form-control text-center" disabled={role === 'manager' ? true : false} value={row.day2} onChange={(event) => changeTimeSheetData('day2', index, Math.min(event.target.value, 16))} /></td>
                                    <td><input type="text"  class="form-control text-center" disabled={role === 'manager' ? true : false} value={row.day3} onChange={(event) => changeTimeSheetData('day3', index, Math.min(event.target.value, 16))} /></td>
                                    <td ><input type="text" class="form-control text-center" disabled={role === 'manager' ? true : false} value={row.day4} onChange={(event) => changeTimeSheetData('day4', index, Math.min(event.target.value, 16))} /></td>
                                    <td><input type="text"  class="form-control text-center" disabled={role === 'manager' ? true : false} value={row.day5} onChange={(event) => changeTimeSheetData('day5', index, Math.min(event.target.value, 16))} /></td>
                                    <td ><input type="text"  class="form-control text-center" disabled={role === 'manager' ? true : false} value={row.day6} onChange={(event) => changeTimeSheetData('day6', index, Math.min(event.target.value, 16))} /></td>
                                    <td><input type="text" class="form-control text-center" disabled={role === 'manager' ? true : false} value={row.day7} onChange={(event) => changeTimeSheetData('day7', index, Math.min(event.target.value, 16))} /></td>
